...
BASS_SFX_WMP_GetPlugin = func_type(HSTREAM, ctypes.c_int, ctypes.POINTER(BASS_SFX_PLUGININFO))(('BASS_SFX_WMP_GetPlugin', bass_vst_module))
# BOOL		SFXDEF(BASS_SFX_WMP_GetPluginW)(int index, BASS_SFX_PLUGININFOW* info);
BASS_SFX_WMP_GetPluginW = func_type(HSTREAM, ctypes.c_int, ctypes.POINTER(BASS_SFX_PLUGINFOW))(('BASS_SFX_WMP_GetPluginW', bass_vst_module))
# DWORD		SFXDEF(BASS_SFX_GetVersion)();
BASS_SFX_GetVersion = func_type(HSTREAM)(('BASS_SFX_GetVersion', bass_vst_module))
#DWORD		SFXDEF(BASS_SFX_ErrorGetCode)();
BASS_SFX_ErrorGetCode = func_type(HSTREAM)(('BASS_SFX_ErrorGetCode', bass_vst_module))
# BOOL		SFXDEF(BASS_SFX_Init)(HINSTANCE hInstance, HWND hWnd);
BASS_SFX_Init = func_type(HSTREAM, ctypes.c_void_p, ctypes.c_void_p)(('BASS_SFX_Init', bass_vst_module))
# DWORD		SFXDEF(BASS_SFX_PluginFlags)(HSFX handle, DWORD flags, DWORD mask);
BASS_SFX_PluginFlags = func_type(HSTREAM, HSFX, ctypes.c_ulong, ctypes.c_ulong)(('BASS_SFX_PluginFlags', bass_vst_module))
# HSFX		SFXDEF(BASS_SFX_PluginCreate)(char* strPath, HWND hPluginWnd, int nWidth, int nHeight, DWORD flags);
BASS_SFX_PluginCreate = func_type(HSTREAM, ctypes.c_char_p, ctypes.c_void_p, ctypes.c_int, ctypes.c_int, ctypes.c_ulong)(('BASS_SFX_PluginCreate', bass_vst_module))
# HSFX		SFXDEF(BASS_SFX_PluginCreateW)(LPCWSTR strPath, HWND hPluginWnd, int nWidth, int nHeight, DWORD flags);
BASS_SFX_PluginCreateW = func_type(HSTREAM, ctypes.c_wchar_p, ctypes.c_void_p, ctypes.c_int, ctypes.c_int, ctypes.c_ulong)(('BASS_SFX_PluginCreate', bass_vst_module))
# int			SFXDEF(BASS_SFX_PluginGetType)(HSFX handle);
BASS_SFX_PluginGetType = func_type(HSTREAM, HSFX)(('BASS_SFX_PluginGetType', bass_vst_module))
# BOOL		SFXDEF(BASS_SFX_PluginSetStream)(HSFX handle, HSTREAM hStream);
BASS_SFX_PluginSetStream = func_type(HSTREAM, HSFX, HSTREAM)(('BASS_SFX_PluginSetStream', bass_vst_module))
# BOOL		SFXDEF(BASS_SFX_PluginStart)(HSFX handle);
BASS_SFX_PluginStart = func_type(HSTREAM, HSFX)(('BASS_SFX_PluginStart', bass_vst_module))
# BOOL		SFXDEF(BASS_SFX_PluginStop)(HSFX handle);
BASS_SFX_PluginStop = func_type(HSTREAM, HSFX)(('BASS_SFX_PluginStop', bass_vst_module))
# char*		SFXDEF(BASS_SFX_PluginGetName)(HSFX handle);
BASS_SFX_PluginGetName = func_type(HSTREAM, HSFX)(('BASS_SFX_PluginGetName', bass_vst_module))
# char*		SFXDEF(BASS_SFX_PluginGetNameW)(HSFX handle);
BASS_SFX_PluginGetNameW = func_type(HSTREAM, HSFX)(('BASS_SFX_PluginGetNameW', bass_vst_module))
# BOOL		SFXDEF(BASS_SFX_PluginConfig)(HSFX handle);
BASS_SFX_PluginConfig = func_type(HSTREAM, HSFX)(('BASS_SFX_PluginConfig', bass_vst_module))
# int			SFXDEF(BASS_SFX_PluginModuleGetCount)(HSFX handle);
BASS_SFX_PluginModuleGetCount = func_type(HSTREAM, HSFX)(('BASS_SFX_PluginModuleGetCount', bass_vst_module))
# char*		SFXDEF(BASS_SFX_PluginModuleGetName)(HSFX handle, int module);
BASS_SFX_PluginModuleGetName = func_type(HSTREAM, HSFX, ctypes.c_int)(('BASS_SFX_PluginModuleGetName', bass_vst_module))
# LPCWSTR		SFXDEF(BASS_SFX_PluginModuleGetNameW)(HSFX handle, int module);
BASS_SFX_PluginModuleGetNameW = func_type(HSTREAM, HSFX, ctypes.c_int)(('BASS_SFX_PluginModuleGetNameW', bass_vst_module))
# BOOL		SFXDEF(BASS_SFX_PluginModuleSetActive)(HSFX handle, int module);
BASS_SFX_PluginModuleSetActive = func_type(HSTREAM, HSFX, ctypes.c_int)(('BASS_SFX_PluginModuleSetActive', bass_vst_module))
# int			SFXDEF(BASS_SFX_PluginModuleGetActive)(HSFX handle);
BASS_SFX_PluginModuleGetActive = func_type(HSTREAM, HSFX)(('BASS_SFX_PluginModuleGetActive', bass_vst_module))
# HBITMAP		SFXDEF(BASS_SFX_PluginRender)(HSFX handle, HSTREAM hStream, HDC hDC); //only sonique, bassbox, or WMP
BASS_SFX_PluginRender = func_type(HSTREAM, HSFX, HSTREAM, ctypes.c_void_p)(('BASS_SFX_PluginRender', bass_vst_module))
# BOOL		SFXDEF(BASS_SFX_PluginClicked)(HSFX handle, int x, int y);
BASS_SFX_PluginClicked = func_type(HSTREAM, HSFX, ctypes.c_int, ctypes.c_int)(('BASS_SFX_PluginClicked', bass_vst_module))
# BOOL		SFXDEF(BASS_SFX_PluginResize)(HSFX handle, int nWidth, int nHeight);
BASS_SFX_PluginResize = func_type(HSTREAM, HSFX, ctypes.c_int, ctypes.c_int)(('BASS_SFX_PluginResize', bass_vst_module))
# BOOL		SFXDEF(BASS_SFX_PluginResizeMove)(HSFX handle, int nLeft, int nTop, int nWidth, int nHeight);
BASS_SFX_PluginResizeMove = func_type(HSTREAM, HSFX, ctypes.c_int, ctypes.c_int, ctypes.c_int, ctypes.c_int)(('BASS_SFX_PluginResizeMove', bass_vst_module))
# BOOL		SFXDEF(BASS_SFX_PluginFree)(HSFX handle);
BASS_SFX_PluginFree = func_type(HSTREAM, HSFX)(('BASS_SFX_PluginFree', bass_vst_module))
# BOOL		SFXDEF(BASS_SFX_Free)();
BASS_SFX_Free = func_type(HSTREAM)(('BASS_SFX_Free', bass_vst_module))
